...
import { Mail, Lock, User as UserIcon, Link2 } from 'lucide-react';
      ...
      <div className="relative w-full max-w-md z-10">
        <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
          ...
          <div className="text-center mb-8">
            <h1 className="text-gray-900 text-3xl mb-2">Create Account</h1>
            <p className="text-gray-600">Join us and start shortening links today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2 text-sm">
              <input 
                type="checkbox" 
                className="w-4 h-4 mt-1 rounded border-gray-300 text-violet-600 focus:ring-violet-500" 
                required
              />
